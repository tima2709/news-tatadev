...
const AttetionList = ({news, className, pathName}) => {
        ...
        <div className={cn("md:flex rounded-[8px] border border-[#E0EBFF] overflow-hidden bg-white", className)}>
            <div className="sm:w-full md:w-[32%]">
                <Image src={news.cover_img} alt={"img"} width={267} height={163}
                       className="object-cover lg:rounded-l-[8px] w-full md:h-full h-[237px]"/>
            </div>
            <div className="sm:w-full md:w-[68%] p-4">
                <div className="flex justify-between items-center mb-2">
                    <span className="text-xs font-semibold text-[#1757B9]">Объявления</span>
